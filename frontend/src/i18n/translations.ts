...
export const translations = {
  en: {
    ...
    "login.cookies": "This website uses cookies to ensure you get the best experience.",
    "login.login": "Login",
  ...
  pt: {
    ...
    "login.cookies": "Este site usa cookies para garantir que obtenha a melhor experiência.",
    "login.login": "Entrar",
